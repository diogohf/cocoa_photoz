...
path= "../projects/source_pca/data"
data_file="source_pcs.dataset"
...
source_pcs_file = ini.relativeFileName('source_pcs_file')
ci.init_redshift_distributions_pcs_from_files(
      source_multihisto_pcs_file=source_pcs_file)
